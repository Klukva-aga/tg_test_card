...
bot = TeleBot(token='5721923743:AAHtXxx27sRS3oBVm4n7BGjWyhqpW5hs5xA', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Добрый день <b>{0.first_name}</b> !\nНужно сгенерировать номер тестовой банковской карты для прохождения тест-кейсов в тестовой среде? Не вопрос!😉\nВыбери тип карты (на данный момент доступно 4 варианта, но этого должно хватить)👇🏼:'.format(message.from_user)
